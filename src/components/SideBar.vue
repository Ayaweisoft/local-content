...
<template>
    <div class="border-r-2 p-4 py-8 md:flex flex-col justify-between hidden sm:flex-auto">
        <div class="">
            ...
            <div class="flex flex-col gap-2">
                ...
                <button class="flex lg:gap-4 items-center bg-[#2bc24126] p-3 px-2 lg:p-3 rounded-xl">
